...
(function (root, factory) {
  ...
  function Init(selector, context) {
    ...
    // If already a paint collection, don't do any further processing
    if (selector.paint && selector !== win) {
      return selector;
    }
  ...
  function paint(selector, context) {
  ...
  paint.parseHTML = parseHTML;
  paint.noop = noop;
  paint.isFunction = isFunction;
  paint.isString = isString;
  ...
  function unique(collection) {
    return paint(slice.call(collection).filter(function (item, index, self) {
  ...
  function registerEvent(node, eventName, callback) {
    var eventCache = getData(node, "_paintEvents") || setData(node, "_paintEvents", {});
  ...
  function removeEvent(node, eventName, callback) {
    var eventCache = getData(node, "_paintEvents")[eventName];
    if (callback) {
  ...
  fn.extend({
    after: function (selector) {
      paint(selector).insertAfter(this);
      return this;
    },
    ...
    appendTo: function (parent) {
      insertContent(paint(parent), this);
      return this;
    },

    before: function (selector) {
      paint(selector).insertBefore(this);
      return this;
    },

    clone: function () {
      return paint(this.map(function (v) {
    ...
    insertAfter: function (selector) {
      ...
      paint(selector).each(function (el, i) {
    ...
    prependTo: function (parent) {
      insertContent(paint(parent), this, true);
      return this;
    },
